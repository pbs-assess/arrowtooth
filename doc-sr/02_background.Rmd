...
if(fr()){
cap <- paste0("Débarquements et rejets récents (en tonnes) de ", sp, " par flotte dans le cadre de la pêche commerciale à l'échelle de la côte. Les colonnes 'Total' représentent la somme des débarquements et des rejets par flotte, et la colonne 'Capture totale' est la somme des colonnes 'Total' des flottes.")
}
