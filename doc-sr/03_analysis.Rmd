...
(ref:fig-catch-streams-nextyr-proj-fr) Projection de la biomasse reproductrice relative de `r base_model$dat$end.yr + 2` pour plusieurs niveaux de capture possibles dans `r base_model$dat$end.yr + 1`. Les points noirs sont les médianes des valeurs postérieures et les lignes noires horizontales sont les IC à 95 % (2,5 %-97,5 %). La ligne rouge continue est le LRP, 0,2B_0$, la ligne bleue pointillée est le candidat USR alternatif, 0,35B_0$, et la ligne verte pointillée est l'USR, 0,4B_0$.
...
(ref:fig-catch-streams-nextnextyr-proj-fr) Projection de la biomasse reproductrice relative de `r base_model$dat$end.yr + 3` pour plusieurs niveaux de capture possibles dans `r base_model$dat$end.yr + 2`. Les points noirs sont les médianes des valeurs postérieures et les lignes noires horizontales sont les IC à 95 % (2,5 %-97,5 %). La ligne rouge continue est le LRP, 0,2B_0$, la ligne bleue pointillée est le candidat USR alternatif, 0,35B_0$, et la ligne verte pointillée est le candidat USR, 0,4B_0$.
...
(ref:fig-catch-streams-nextnextnextyr-proj-fr) Projection de la biomasse reproductrice relative de `r base_model$dat$end.yr + 4` pour plusieurs niveaux de capture possibles dans `r base_model$dat$end.yr + 3`. Les points noirs sont les médianes des valeurs postérieures et les lignes noires horizontales sont les IC à 95 % (2,5 %-97,5 %). La ligne rouge continue est le LRP, 0,2B_0$, la ligne bleue pointillée est le candidat USR alternatif, 0,35B_0$, et la ligne verte pointillée est le candidat USR, 0,4B_0$.
