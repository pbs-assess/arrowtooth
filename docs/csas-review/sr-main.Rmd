...
- DFO Sustainable Fisheries Framework (SFF) reference points could not be used, as the selectivity estimates included non-mature fish which appeared to make the entire stock vulnerable to the stock
- 
]
