...
- Beginning November 1, 2023, a new at-sea sampling pilot program for `r sp` commenced on select *Option A* groundfish trawl vessels delivering frozen products.

- Vessel crew are responsible for collecting random samples from unsorted catch at-sea and deliver them to dockside monitoring program staff.

- Vessel delivers representative `r sp` samples to dockside observers for biological sampling.

- Not applicable to vessels delivering fresh product (Shoreside vessels or 'wet' boats).
