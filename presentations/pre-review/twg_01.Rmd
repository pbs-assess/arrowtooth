...
```{r length-comps}
plot_lengths(lc_coast, show_year = "even") +
  ggtitle(NULL) +
...
```{r length-comps-3cd}
plot_lengths(lc_3cd, show_year = "even") +
  ggtitle(NULL) +
  scale_x_continuous(breaks = seq(from = 0, to = 100, by = 5))
```
...
```{r length-comps-5ab}
plot_lengths(lc_5ab, show_year = "even") +
  ggtitle(NULL) +
  scale_x_continuous(breaks = seq(from = 0, to = 100, by = 5))
```
...
```{r lw-relationship}
fm_color <- c(Female = "blue", Male = "red")
