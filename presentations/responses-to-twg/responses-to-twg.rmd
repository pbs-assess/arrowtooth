...
# Request 2 - Show vonBertalanffy fits and parameter values for survey data. Produce a plot comparing vonB parameter values among surveys.

```{r vonBfits, fig.cap="von B fits to survey data.", fig.asp=0.9, cache=TRUE, results='hide'}
...
```{r vonBpars, fig.cap="von B pars", cache=TRUE, results='hide'}
...
```{r vonBfits-all, fig.cap="von B fits to all survey data.", fig.asp=0.8, out.width="4.5in", fig.width=5.5, cache=TRUE, results='hide'}
...
# Request 3 - Create a 'Discard' CPUE by filtering wet boat Arrowtooth discards for trips where Arrowtooth were not retained (landed).
