...
**Parameters** 
Them model includes the main leading parameters
\begin{flalign}
  \Theta = (R_o,h,M); \qquad R_o>0; \qquad 0.2 \leq h < 1.0; \qquad M_s > 0 &&
  \label{eq:df01} &&
\end{flalign}
and fixed growth and maturity parameters
\begin{flalign}
