...
```{r tab-app-model-desc, results = 'asis'}

cap <- ifelse(fr(),
              paste0("Une liste de symboles, de constantes et une ",
                     "description des variables utilisées dans l'", iscam, "."),
              paste0("A list of symbols, constants and a ",
                       "description of the variables used in ", iscam, "."))
