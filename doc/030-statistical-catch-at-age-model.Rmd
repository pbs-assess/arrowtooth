...
With regards to other jurisdictions worldwide, several use 0.4 $B_0$ as a default 'target' stock size [@punt2008, and references therein]; however, these jurisdictions (US Pacific Fishery Management Council, US North Pacific Fishery Management Council, and the Australian Fisheries Management Authority) also use this 'target' as an operational control point (OCP) below which fishing mortality is to be reduced to avoid hitting what DFO calls the Limit Reference Point [@punt2008, and references therein]. In other words, their 'target' matches the definition of the Canadian USR as an OCP. This is reflected in the common '40:10' harvest control rule used in the US [@PFMC1998; @punt2008], where the '40' typically refers to 0.4 $B_0$. This interpretation would suggest that, despite the use of the term 'target' for 0.4 $B_0$ elsewhere, a USR of 0.4 $B_0$ would be equivalent in function to these jurisdictions. Most equivalent in function to these jurisdictions would be to consider 0.4 $B_0$ both a 'target' and a USR OCP rather than how they are separated in the PA Policy diagram.
