...
A two-sex, Bayesian statistical catch-at-age model was applied to assess the coastwide stock status of `r sp`. The model is based on the Integrated Statistical Catch Age Model (iSCAM) framework, @martell2011. Full model details are provided in Appendix \@ref(app:model-desc).
