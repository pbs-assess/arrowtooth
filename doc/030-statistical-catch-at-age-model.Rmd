...
Selectivity-at-age was estimated for the two fisheries and the synoptic surveys (Figures \@ref(fig:fig-base-mcmc-selex)). The `r dcpue` and `r hsmas` fixed selectivities are also shown in Figure \@ref(fig:fig-base-mcmc-selex).
