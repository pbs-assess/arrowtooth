...
```{r geo-individual-en, fig.cap="Individual geostatistical indices compared to design-based indices.", eval=!fr(), results='asis'}
 knitr::include_graphics(here("arrowtooth-nongit/geostat-figs/geostat-individual-vs-design.png"), dpi = NA)
```
