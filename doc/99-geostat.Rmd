...
```{r geo-bubble1-en, fig.cap="Raw survey data bubble plot for 2003 to 2012.", out.width="\\textwidth", eval=!fr(), results='asis'}
knitr::include_graphics(file.path(drs$nongit_dir, "geostat-figs", "geostat-map-raw1.png"), dpi = NA)
```

```{r geo-bubble2-en, fig.cap="Raw survey data bubble plot for 2013 to 2021.", out.width="\\textwidth", eval=!fr(), results='asis'}
knitr::include_graphics(file.path(drs$nongit_dir, "geostat-figs", "geostat-map-raw2.png"), dpi = NA)
```

```{r geo-predmap1-en, fig.cap="Predicted biomass density (units TODO) for 2003 to 2012.", out.width="\\textwidth", eval=!fr(), results='asis'}
knitr::include_graphics(file.path(drs$nongit_dir, "geostat-figs", "geostat-map-pred1.png"), dpi = NA)
```

```{r geo-predmap2-en, fig.cap="Predicted biomass density (units TODO) for 2013 to 2021.", out.width="\\textwidth", eval=!fr(), results='asis'}
