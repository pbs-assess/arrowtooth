...
(ref:fig-base-selex-en) Estimated and fixed selectivities (Discard CPUE) for each sex for the base model. The dots are estimated selectivity-at-age, the shaded areas around are the 95% CI for those estimates. Dotted lines represent maturity, with the colours representing the sexes and are the same as for selectivity curves.
