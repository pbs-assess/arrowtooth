...
(ref:fig-base-age-fits-ss-firsthalf-en-alt) This figure shows that ages from the Shoreside fleet from 1996 to 2007 are fit well

(ref:fig-base-age-fits-ss-firsthalf-fr-alt) Ce graphique montre que les âges de la flotte Shoreside entre 1996 et 2007 correspondent bien
...
(ref:fig-base-age-fits-ss-secondhalf-en-alt) This figure shows that ages from the Shoreside fleet from 2008 to 2019 are fit well although there are some years of missing data

(ref:fig-base-age-fits-ss-secondhalf-fr-alt) Ce graphique montre que les âges de la flotte Shoreside entre 2008 et 2019 correspondent bien même si certaines années manquent
...
(ref:fig-base-selex-en-alt) This figure shows that the maturity ogive lies to the right of the selectivity curves for all surveys and both commercial fisheries for both male and female

(ref:fig-base-selex-fr-alt) Ce graphique montre que l'ogive de maturité se situe à droite des courbes de sélectivité pour toutes les études et les deux pêcheries commerciales tant pour les mâles que pour les femelles
