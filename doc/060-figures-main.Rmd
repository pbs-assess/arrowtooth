...
(ref:fig-base-index-fits-en) Index fits for the base model. The light grey points and vertical lines show the index values and 95% confidence intervals; the blue points show the medians of the posteriors; the black solid vertical lines show the 95% credible intervals of the posteriors.
...
(ref:fig-base-index-resids-en) Index log standardized residuals. The points are the median of the posteriors for the $\epsilon_{k,t}$ parameters in iSCAM. The vertical lines represent the 95% credible intervals for those posteriors.
