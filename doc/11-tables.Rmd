...
cap <- paste0("Age-at-5\\%, 50\\%, and 95\\% maturity by sex. Number of specimens ",
              "used in the calculation is also given.")
if(fr()){
cap <- paste0("Âge à 5 \\%, 50 \\% et 95 \\% de maturité par sexe. Le nombre de ",
              "spécimens utilisés dans le calcul est également indiqué.")
}
