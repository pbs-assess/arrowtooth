...
cap <- paste0("Values used in the iSCAM models for Age-at-50\\% and SD-at-50\\% ",
              "maturity by sex. Number of specimens used in the calculation is ",
              "also given.")
if(fr()){
cap <- paste0("Valeurs utilisées dans les modèles iSCAM pour la maturité ",
              "Age-at-50\\% et SD-at-50\\% par sexe. Le nombre de spécimens utilisés ",
              "dans le calcul est également indiqué.")
}
