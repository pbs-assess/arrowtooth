...
Juvenile `r sp` feed primarily on mobile prey such as cumaceans, carideans and amphipods. Adults are piscivorous and cannibalistic, feeding on Pacific Herring (*Clupea pallasii*), juvenile Walleye Pollock (*Theragra chalcogramma*) and Pacific Sandlance (*Ammodytes hexapterus*), among other species [@fargo1981].
