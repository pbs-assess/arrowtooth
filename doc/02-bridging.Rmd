...
(ref:fig-bridge1-selectivities) Maximum Posterior Density (MPD) maturity ogives and selectivity estimates for all gears in the models with one fleets and one sex. The blue and red lines are the male and female maturity ogives respectively, and the dotted green lines are the yearly selectivity estimates.
...
(ref:fig-bridge2-selectivities) Maximum Posterior Density (MPD) maturity ogives and selectivity estimates for all gears in the models with one fleet and two sexes. The blue and red lines are the male and female maturity ogives respectively, and the dotted green lines are the yearly selectivity estimates.
...
(ref:fig-bridge3-selectivities) Maximum Posterior Density (MPD) maturity ogives and selectivity estimates for all gears in the models with two fleets and one sex. The blue and red lines are the male and female maturity ogives respectively, and the dotted green lines are the yearly selectivity estimates.
...
(ref:fig-bridge4-selectivities) Maximum Posterior Density (MPD) maturity ogives and selectivity estimates for all gears in the models with two fleets and two sexes. The blue and red lines are the male and female maturity ogives respectively, and the dotted green lines are the yearly selectivity estimates.
