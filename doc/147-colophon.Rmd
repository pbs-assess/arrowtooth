...
cat("**gfiscam** is not listed above, as it is not an R package. It is an ADMB/C++ package containing the `r iscam` implementation and has a GitHub repository (link below).
...
cat("Les paquets maintenus par les auteurs et utilisés pour générer ce rapport peuvent être consultés à l'adresse suivante:
