...
In order to quantify the uncertainty in retrospective patterns, and therefore retrospective bias, Mohn's $\rho$ statistic was calculated for all `r length(retro_models_dirs[[1]])` retrospective models compared to the base model to be 0.99.
