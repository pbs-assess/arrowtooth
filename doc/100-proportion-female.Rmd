...
cap <- paste0("Summary of samples and weights used for the calculation of proportion of female ", sp, "in the commercial trawl fishery. See Table \\ref{tab:prop-female-table} for survey acronym meanings.")
if(fr()){
  cap <- paste0("French here")
}
