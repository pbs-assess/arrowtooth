...
(ref:fig-sens-sel-eq-mat-autocor-en) Autocorrelation for non-selectivity parameters for the sensitivity model which has both commercial fleets' selectivity fixed to maturity.
...
(ref:fig-sens-sel-eq-mat-autocor-sel-en) Autocorrelation for estimated selectivity parameters for the sensitivity model which has both commercial fleets' selectivity fixed to maturity.
...
(ref:fig-sens-qcs-tv-en) Time-varying selectivity for the `r qcs`, in year blocks. The plot shows an unreasonable situation for females in the second block, where both the medians and all the lower limits of the CI were estimated as 0.5. Also, males in the first block are 

(ref:fig-sens-sel-eq-mat-autocor-sel-fr) French here


```{r fig-sens-selex-sel, fig.cap = ifelse(fr(), "(ref:fig-sens-selex-index-fits-fr)", "(ref:fig-sens-selex-index-fits-en)")}
