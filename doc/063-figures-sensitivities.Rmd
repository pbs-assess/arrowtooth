...
(ref:fig-sens-qcs-tv-autocor-sel-en) Autocorrelation for estimated selectivity parameters for the sensitivity model which has time-varying selectivity for the `r qcs`. See Figure \@ref(fig:fig-base-trace-selex) for descriptions of the parameter subscripts.

(ref:fig-sens-qcs-tv-autocor-sel-fr) French here

```{r fig-sens-qcs-autocor-sel-tv, fig.cap = ifelse(fr(), "(ref:fig-sens-qcs-tv-autocor-sel-fr)", "(ref:fig-sens-qcs-tv-autocor-sel-en)")}
plot_autocorr_mcmc(models$sens_grps[[4]][[3]],
                   plot_sel = TRUE, 
                   text_title_size = NULL,
                   lag_max = 1000,
