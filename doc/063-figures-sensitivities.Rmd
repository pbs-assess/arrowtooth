...
(ref:fig-sens-q-en-alt) This figure shows that manipulation of the prior on catchabilities for all the surveys does not have much effect at all on the spawning biomass estimates

(ref:fig-sens-q-fr-alt) Ce graphique montre que la manipulation des a priori sur les taux de capture pour toutes les enquêtes n'a pratiquement aucun effet sur les estimations de la biomasse reproductrice
...
(ref:fig-sens-q-q-en-alt) Ce graphique montre que la manipulation de l'a priori sur les taux de capture pour toutes les enquêtes a un effet limité sur les estimations des taux de capture
