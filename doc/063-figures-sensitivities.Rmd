...
```{r fig-sens-selex-qcs, fig.cap = ifelse(fr(), "(ref:fig-sens-selex-index-fits-fr)", "(ref:fig-sens-index-fits-en)")}
...
(ref:fig-sens-selex-selectivity-en) Estimated `r qcs` selectivities for three time blocks when QCS selectitivy was allowed to vary. The parameters are poorly estimated in the middle block.

(ref:fig-sens-selex-selectivity-fr) French here

```{r fig-sens-selex-selectivity, fig.cap = ifelse(fr(), "(ref:fig-sens-selex-selectivity-fr)", "(ref:fig-sens-selex-selectivity-en)")}
