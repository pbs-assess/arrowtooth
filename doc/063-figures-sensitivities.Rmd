...
```{r fig-sens-qcs-autocor-sel, fig.cap = ifelse(fr(), "(ref:fig-sens-qcs-autocor-sel-fr)", "(ref:fig-sens-qcs-autocor-sel-en)")}
plot_autocorr_mcmc(models$sens_grps[[4]][[3]],
                   plot_sel = TRUE, 
                   text_title_size = NULL,
                   lag_max = 1000,
...
(ref:fig-sens-qcs-trace-tv-en) Trace plots for non-selectivity parameters for the sensitivity model which has time-varying selectivity for the `r qcs`. See Figure \@ref(fig:fig-base-trace) for parameter and subscript descriptions.

(ref:fig-sens-qcs-trace-tv-fr) French here

```{r fig-sens-qcs-trace-tv, fig.cap = ifelse(fr(), "(ref:fig-sens-qcs-trace-tv-fr)", "(ref:fig-sens-qcs-trace-tv-en)")}
...
```{r fig-sens-qcs-trace-sel-tv, fig.cap = ifelse(fr(), "(ref:fig-sens-qcs-trace-sel-tv-fr)", "(ref:fig-sens-qcs-trace-sel-tv-en)")}
plot_traces_mcmc(models$sens_grps[[4]][[3]],
                 plot_sel = TRUE, 
                 text_title_size = NULL,
                 col = "blue",
