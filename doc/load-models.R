...
sens_models_text <-
  list(c(ifelse(fr(),
       ...
       c(ifelse(fr(),
                "Estimation de $\\operatorname{ln}(M_{femme})$ avec sd préalable = 0,2",
                "Estimate $\\operatorname{ln}(M_{Female})$ with prior sd = 0.2"),
         ifelse(fr(),
                "Estimation de $\\operatorname{ln}(M_{femme})$ avec sd préalable = 1,6",
                "Estimate $\\operatorname{ln}(M_{Female})$ with prior sd = 1.6"),
         ifelse(fr(),
                "Estimation de $\\operatorname{ln}(M_{homme})$ avec sd préalable = 0,2",
                "Estimate $\\operatorname{ln}(M_{Male})$ with prior sd = 0.2"),
         ifelse(fr(),
                "Estimation de $\\operatorname{ln}(M_{homme})$ avec sd préalable = 1,6",
                "Estimate $\\operatorname{ln}(M_{Male})$ with prior sd = 1.6")),
       c(ifelse(fr(),
                "Augmenter la moyenne antérieure de $\\operatorname{ln}(q_{k})$ à 1,0",
                "Increase $\\operatorname{ln}(q_k)$ prior mean to 1.0"),
         ifelse(fr(),
                "Priorité plus large sur $\\operatorname{ln}(q_{k})$, sd préalable = 1,5",
                "Broader prior on $\\operatorname{ln}(q_k)$, prior sd = 1.5")),
       c(ifelse(fr(),
...
sens_changes_text <-
  list(c("$\\vartheta^2 = 1.519$; $\\rho = 0.028$",
         ...
         "$\\operatorname{Beta}(\\alpha = 11.72, \\beta = 4.56)$"),
       c(ifelse(fr(),
                "$\\operatorname{Normale}(\\operatorname{ln}(0.20), 0.5)$",
                "$\\operatorname{Normal}(\\operatorname{ln}(0.20), 0.5)$"),
         ifelse(fr(),
                "$\\operatorname{Normale}(\\operatorname{ln}(0.20), 2.5)$",
                "$\\operatorname{Normal}(\\operatorname{ln}(0.20), 2.5)$"),
         ifelse(fr(),
                "$\\operatorname{Normale}(\\operatorname{ln}(0.35), 0.5)$",
                "$\\operatorname{Normal}(\\operatorname{ln}(0.35), 0.5)$"),
         ifelse(fr(),
                "$\\operatorname{Normale}(\\operatorname{ln}(0.35), 2.5)$",
                "$\\operatorname{Normal}(\\operatorname{ln}(0.35), 2.5)$")),
       c(ifelse(fr(),
                "$\\operatorname{Normal}(\\operatorname{ln}(1.0), 0.5)$ pour tous les engrenages $k$",
                "$\\operatorname{Normal}(\\operatorname{ln}(1.0), 0.5)$ for all gears $k$"),
         ifelse(fr(),
                "$\\operatorname{Normal}(\\operatorname{ln}(0.5), 1.5)$ pour tous les engrenages $k$",
                "$\\operatorname{Normal}(\\operatorname{ln}(0.5), 1.5)$ for all gears $k$")),
       c(ifelse(fr(),
