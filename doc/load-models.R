...
sens_models_text <-
  list(c(ifelse(fr(),
       ...
       c(ifelse(fr(),
                "Estimation de $ln(M_{femme})$ avec sd préalable = 0,2",
                "Estimate $ln(M_{Female})$ with prior sd = 0.2"),
         ifelse(fr(),
                "Estimation de $ln(M_{femme})$ avec sd préalable = 1,6",
                "Estimate $ln(M_{Female})$ with prior sd = 1.6"),
         ifelse(fr(),
                "Estimation de $ln(M_{homme})$ avec sd préalable = 0,2",
                "Estimate $ln(M_{Male})$ with prior sd = 0.2"),
         ifelse(fr(),
                "Estimation de $ln(M_{homme})$ avec sd préalable = 1,6",
                "Estimate $ln(M_{Male})$ with prior sd = 1.6")),
       c(ifelse(fr(),
         ...
         ifelse(fr(),
                ...
                "Broader prior on $ln(q_k)$, prior sd = 1.5")),
       c(ifelse(fr(),
