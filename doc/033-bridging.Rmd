...
The Technical Working Group (TWG) agreed that the model should be two-sex, based on the sexual dimorphism observed in the age and length data for this species, and there being eight more years of data since the `r la`, which allowed for a larger number of age proportion specimens for each sex.
...
1. Converted the model from female-only to a two-sex model. In this model, the two natural mortality parameters for male and female were estimated.
