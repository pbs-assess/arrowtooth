...
library(csasdown)
library(gfutilities)
devtools::load_all("C:/github/pbs-assess/gfiscamutils/")
...
bridge_models_dirs <- list(c("09-bridge-switch-fishing-year-to-feb-21-feb-20"))
bridge_models_text <- list(c("Split-sex, two-fleet, Feb 21-Feb 20"))
