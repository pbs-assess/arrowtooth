...
bridge_models_dirs <- list(# One fleet, one sex,
                           c("01-base",
                           ...
                           c("03-bridge-update-data-to-2021",
                             "50-bridge-2fleet-update-data-to-2021",
...
bridge_models_text <- list(c("2015 Base model",
                           ...
                           c("Update data to 2021",
                             ...
                             "Add Discard CPUE index (two fleets)"),
                           c("Add Discard CPUE index (two fleets)",
                             "Convert model to split sex (two fleets)",
                             "Change fishing year to Feb 21 - Feb 20 (two fleets)",
                             "Fix male M=0.35, female M=0.2 (two fleets)"))
...
dat <- readRDS(file.path(drs$nongit_dir, "data", "arrowtooth-flounder-aug10-2021.rds"))
