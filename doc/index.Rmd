...
sens_models_dirs <-
  list(c("001-sigma-0.1",
         "002-estimate-total-variance"),
       c("003-tau-1.0",
         "004-tau-0.6"),
       c("005-low-steepness"),
       c("006-m-female-tight-prior",
         "007-m-female-loose-prior"),
       c("008-m-male-tight-prior",
         "009-m-male-loose-prior"),
       c("010-qk-mean-1.0",
         "011-qk-loose-prior"),
       c("012-selex-equal-maturity"),
       c("013-stitched-index"))
sens_models_text <-
  list(c(ifelse(fr(),
