...
bridge_models_text <- 
  list(c("2015 Base model (one fleet, single sex)",
       ...
       c("Change fishing year to Feb 21 - Feb 20 (two fleets, split sex)",
         "Remove WCHG age comps and index",
         "Fix natural mortalities",
         "QCS survey 2 block TV selex"))
