...
survey_index <- add_extra_indices(
  survey_index, 
  data_path = file.path(drs$nongit_dir, "data"),
  iphc_rds_fn = "iphc-survey-index.rds",
  discard_cpue_csv_fn = "cpue-predictions-arrowtooth-flounder-modern-3CD5ABCDE-Feb21-Feb20.csv",
