...
get_parvals <- function(model, val, digits = 0){
...
bridge_1_4_bo <- get_parvals(models$bridge_grps[[1]][[4]], "bo")
bridge_1_4_sbt <- get_parvals(models$bridge_grps[[1]][[4]], "sbt")
bridge_1_4_depl <- get_parvals(models$bridge_grps[[1]][[4]], "depl", 2)

bridge_2_1_bo <- get_parvals(models$bridge_grps[[2]][[1]], "bo")
bridge_2_1_sbt <- get_parvals(models$bridge_grps[[2]][[1]], "sbt")
bridge_2_1_depl <- get_parvals(models$bridge_grps[[2]][[1]], "depl", 2)

bridge_2_4_bo <- get_parvals(models$bridge_grps[[2]][[4]], "bo")
bridge_2_4_sbt <- get_parvals(models$bridge_grps[[2]][[4]], "sbt")
bridge_2_4_depl <- get_parvals(models$bridge_grps[[2]][[4]], "depl", 2)

bridge_3_1_bo <- get_parvals(models$bridge_grps[[3]][[1]], "bo")
bridge_3_1_sbt <- get_parvals(models$bridge_grps[[3]][[1]], "sbt")
bridge_3_1_depl <- get_parvals(models$bridge_grps[[3]][[1]], "depl", 2)
