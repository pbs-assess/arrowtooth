...
sens_models_text <-
  list(c("$\\sigma$ = 0.1",
       ...
       c(ifelse(fr(),
                ...
                "Low steepness")),
       c(ifelse(fr(),
                "Femelle M serrée avant",
                "Female M tight prior"),
         ifelse(fr(), 
                "Femelle M lâche avant",
                "Female M loose prior")),
       c(ifelse(fr(),
                "Mâle M serré avant",
                "Male M tight prior"),
         ifelse(fr(),
                ...
                "Male M loose prior")),
       c(ifelse(fr(),
                "Moyenne antérieure de capturabilité = 1.0",
                "Catchability prior mean = 1.0"),
         ifelse(fr(),
                "La capturabilité lâche avant",
                "Catchability loose prior")),
       c(ifelse(fr(),
                "Sélectivité égale maturité",
                "Selectivity equals maturity")),
       c(ifelse(fr(),
...
sens_changes_text <-
  list(c("$\\vartheta^2$ = 1.538; $\\rho$ = 0.059",
       ...
       c(ifelse(fr(),
                ...
                "Catchability prior mean = 1.0"),
         ifelse(fr(),
                "Catchabilité antérieure sd = 1.5",
                "Catchability prior sd = 1.5")),
       c(ifelse(fr(),
