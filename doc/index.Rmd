...
bridge_models_dirs <- list(c("01-base",
                             ...
                             "04-bridge-add-discard-cpue"),
                           c("04-bridge-add-discard-cpue",
                             "05-bridge-convert-to-splitsex",
                             "06-bridge-fishing-year-feb-21-feb-20",
                             #"07-bridge-reduce-m-prior-0.2-.05",
                             #"08-bridge-increase-m-prior-0.2-0.4",
                             #"09-bridge-fix-m-2-2",
                             "10-bridge-fix-m-2-35"),
                           c("03-bridge-update-data-to-2021",
                             "50-bridge-2fleet-update-data-to-2019",
                             "51-bridge-2fleet-add-discard-cpue"),
                           c("51-bridge-2fleet-add-discard-cpue",
                             "52-bridge-2fleet-convert-to-splitsex",
                             "53-bridge-2fleet-fishing-year-feb-21-feb-20",
                             #"54-bridge-2fleet-reduce-m-prior-0.2-.05",
                             #"55-bridge-2fleet-increase-m-prior-0.2-0.4",
                             #"56-bridge-2fleet-fix-m-2-2",
                             "57-bridge-2fleet-fix-m-2-35"))
                             #"58-bridge-2fleet-fix-m-2-35-stitched-surveys",
                             #"59-bridge-2fleet-fishing-year-feb-21-feb-20-no-qcs"))

bridge_models_text <- list(c("2015 Base model",
                             "Update data to 2014",
                             "Update data to 2021",
                             "Add Discard CPUE index"),
                           c("Add Discard CPUE index",
                             "Convert model to split sex",
                             "Change fishing year to Feb 21 - Feb 20",
                             #"Reduce SD on M prior from 0.2 to 0.05",
                             #"Increase SD on M prior from 0.2 to 0.4",
                             #"Fix male M=0.2, female M=0.2",
                             "Fix male M=0.35, female M=0.2"),
                           c("Update data to 2021",
                             "Change to two-fleet model",
                             "Add Discard CPUE index"),
                           c("Add Discard CPUE index",
                             "Convert model to split sex",
                             "Change fishing year to Feb 21 - Feb 20",
                             ...
                             #"Fix male M=0.2, female M=0.2",
                             "Fix male M=0.35, female M=0.2"))
                             #"Replace 3 Synoptic surveys with Stitched",
                             #"Remove QCS from 'change fishing year' model"))
...
sens_models_dirs <- list(c("02-bridge-update-data-to-2014",
                           "03-bridge-update-data-to-2019"),
                         c("04-bridge-add-discard-cpue",
                           "05-bridge-convert-to-splitsex"),
                         "06-bridge-fishing-year-feb-21-feb-20")
sens_models_text <- list(c("Update data to 2014",
                           "Update data to 2019"),
                         c("Add Discard CPUE index",
                           "Convert model to split sex"),
                         "Change fishing year to Feb 21 - Feb 20")
...
dat <- readRDS(file.path(drs$nongit_dir, "data", "arrowtooth-flounder-july28-2021.rds"))
...
discard_cpue_file <- file.path(data_dir, "cpue-predictions-arrowtooth-flounder-modern-3CD5ABCDE-Feb21-Feb20.csv")
