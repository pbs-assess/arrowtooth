...
(ref:fig-priors-posts-cap) Prior probability distributions used in the Reference Case with comparative posterior histograms. Parameters $q_k$ represent gears where: k = 2 is the `r qcsss`, k = 3 is the `r hsmas`, k = 4 is the `r hsss`, and k = 5 is the `r wcviss`. The dotted red lines are the MPD estimates from the Reference Case.
