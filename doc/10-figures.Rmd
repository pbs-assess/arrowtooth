...
g_cw <- survey_samples_syn |>
  plot_vb_panels() +
  ggtitle(en2fr("Coastwide", fr()))
...
g_3 <- survey_samples |>
  filter(survey_abbrev %in% "SYN HS") |>
  plot_vb_panels() +
  ggtitle(en2fr("SYN HS (5CD)", fr()))

g_4 <- survey_samples |>
  filter(survey_abbrev %in% "SYN WCVI") |>
  plot_vb_panels() +
  ggtitle(en2fr("SYN WCVI (3CD)", fr()))
...
ma_cw <- survey_samples_syn |>
  plot_mat_panels() +
  ggtitle(en2fr("Coastwide synoptic trawl surveys", fr()))

ml_cw <- survey_samples_syn |>
