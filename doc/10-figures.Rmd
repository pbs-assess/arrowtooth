...
cowplot::plot_grid(plot_ts_mpd(models$bridge_models[[1]], type = "sbt"),
                   plot_ts_mpd(models$bridge_models[[1]], type = "sbt", rel = TRUE) + 
...
plot_ts_mpd(models$bridge_models[[1]], type = "rt") +
...
plot_index_fit_mpd(models$bridge_models[[1]], surv_index = survey_index)
```
...
cowplot::plot_grid(plot_ts_mpd(models$bridge_models[[2]], type = "sbt"),
                   plot_ts_mpd(models$bridge_models[[2]], type = "sbt", rel = TRUE) + 
                     coord_cartesian(ylim = c(0, 1)), nrow = 2)
...
plot_ts_mpd(models$bridge_models[[2]], type = "rt") +
  coord_cartesian(ylim = c(0, 1.5))
```
...
plot_index_fit_mpd(models$bridge_models[[2]], surv_index = survey_index)
```
