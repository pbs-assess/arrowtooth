...
(ref:fig-base-trace-en) Trace plots for MCMC output of estimated lead parameters in the base model. The MCMC run has chain length `r f(mcmc_chain_length)` with a sample taken every `r f(mcmc_sample_freq)`^th^ iteration. Of the `r f(mcmc_num_samples)` samples taken, the first 1,000 were removed as a burn-in period.
...
(ref:fig-base-trace-selex-en) Trace plots for MCMC output of estimated selectivity parameters in the base model. See Figure \@ref(fig:fig-base-trace) for parameter descriptions.
...
(ref:fig-base-autocor-selex-en) Autocorrelation plots for MCMC output of estimated selectivity parameters in the base model. See Figure \@ref(fig:fig-base-trace) for parameter descriptions.
