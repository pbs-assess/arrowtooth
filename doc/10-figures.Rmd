...
(ref:fig-bridge1-biomass) Maximum Posterior Density (MPD) estimates of spawning biomass (top panel) and relative spawning biomass (bottom panel) for the 2015 base model and models with cumulative changes to that model progressing toward a new, split-sex base model with a modified fishing year.
...
cowplot::plot_grid(plot_ts_mpd(models$bridge_models[[1]], type = "sbt", line_width = 0.5, point_size = 2, legend_title = "Bridge models - 1 fleet"),
                   plot_ts_mpd(models$bridge_models[[1]], type = "sbt", rel = TRUE, line_width = 0.5, legend_title = "Bridge models - 1 fleet") + 
                     coord_cartesian(ylim = c(0, 1)), nrow = 2)
                   
```

(ref:fig-bridge1-recruitment) Maximum Posterior Density (MPD) estimates of recruitment for the 2015 base model and models with cumulative changes to that model progressing toward a new, split-sex base model with a modified fishing year.
...
plot_ts_mpd(models$bridge_models[[1]], type = "rt", line_width = 0.5, point_size = 2, legend_title = "Bridge models - 1 fleet") +
  coord_cartesian(ylim = c(0, 1.5))
```

(ref:fig-bridge1-index-fits) Maximum Posterior Density (MPD) index fits for the 2015 base model and models with cumulative changes to that model progressing toward a new, split-sex base model with a modified fishing year.
...
plot_index_fit_mpd(models$bridge_models[[1]], surv_index = survey_index, line_width = 0.5, point_size = 1, legend_title = "Bridge models - 1 fleet")
```



(ref:fig-bridge2-biomass) Maximum Posterior Density (MPD) estimates of spawning biomass (top panel) and relative spawning biomass (bottom panel) for the 2015 base model and models with cumulative changes to that model progressing toward a new, split-sex base model with a modified fishing year.
...
cowplot::plot_grid(plot_ts_mpd(models$bridge_models[[2]], type = "sbt", line_width = 0.5, point_size = 2, legend_title = "Bridge models - 2 fleets"),
                   plot_ts_mpd(models$bridge_models[[2]], type = "sbt", rel = TRUE, line_width = 0.5, legend_title = "Bridge models - 2 fleets") + 
                     coord_cartesian(ylim = c(0, 1)), nrow = 2)
                   
```

(ref:fig-bridge2-recruitment) Maximum Posterior Density (MPD) estimates of recruitment for the 2015 base model and models with cumulative changes to that model progressing toward a new, split-sex base model with a modified fishing year.
...
plot_ts_mpd(models$bridge_models[[2]], type = "rt", line_width = 0.5, point_size = 2, legend_title = "Bridge models - 2 fleets") +
  coord_cartesian(ylim = c(0, 1.5))
```

(ref:fig-bridge2-index-fits) Maximum Posterior Density (MPD) index fits for the 2015 base model and models with cumulative changes to that model progressing toward a new, split-sex base model with a modified fishing year.
...
plot_index_fit_mpd(models$bridge_models[[2]], surv_index = survey_index, line_width = 0.5, point_size = 1, legend_title = "Bridge models - 2 fleets")
```



(ref:fig-bridge3-biomass) Maximum Posterior Density (MPD) estimates of spawning biomass (top panel) and relative spawning biomass (bottom panel) for the 2015 base model and models with cumulative changes to that model progressing toward a new, split-sex base model with a modified fishing year.
...
cowplot::plot_grid(plot_ts_mpd(models$bridge_models[[3]], type = "sbt", line_width = 0.5, point_size = 2, legend_title = "Bridge models - 2 fleets"),
                   plot_ts_mpd(models$bridge_models[[3]], type = "sbt", rel = TRUE, line_width = 0.5, legend_title = "Bridge models - 2 fleets") + 
                     coord_cartesian(ylim = c(0, 1)), nrow = 2)
                   
```

(ref:fig-bridge3-recruitment) Maximum Posterior Density (MPD) estimates of recruitment for the 2015 base model and models with cumulative changes to that model progressing toward a new, split-sex base model with a modified fishing year.
...
plot_ts_mpd(models$bridge_models[[3]], type = "rt", line_width = 0.5, point_size = 2, legend_title = "Bridge models - 2 fleets") +
  coord_cartesian(ylim = c(0, 0.4))
```

(ref:fig-bridge3-index-fits) Maximum Posterior Density (MPD) index fits for the 2015 base model and models with cumulative changes to that model progressing toward a new, split-sex base model with a modified fishing year.
...
plot_index_fit_mpd(models$bridge_models[[3]], surv_index = survey_index, line_width = 0.5, point_size = 1, legend_title = "Bridge models - 2 fleets")
```
