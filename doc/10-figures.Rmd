...
(ref:fig-bridge-biomass) Maximum Posterior Density (MPD) estimates of spawning biomass (top panel) and relative spawning biomass (bottom panel) for the 2015 base model and models with cumulative changes to that model progressing toward a new, split-sex base model with a modified fishing year.
...
cowplot::plot_grid(plot_ts_mpd(models$bridge_models, bridge_models_text, "sbt"),
                   plot_ts_mpd(models$bridge_models, bridge_models_text, "sbt", rel = TRUE) + 
                     coord_cartesian(ylim = c(0, 1)), nrow = 2)
                   
```

(ref:fig-bridge-recruitment) Maximum Posterior Density (MPD) estimates of recruitment for the 2015 base model and models with cumulative changes to that model progressing toward a new, split-sex base model with a modified fishing year.
...
(ref:fig-bridge-index-fits) Maximum Posterior Density (MPD) index fits for the 2015 base model and models with cumulative changes to that model progressing toward a new, split-sex base model with a modified fishing year.
...
plot_index_fit_mpd(models[[2]], survey_index)
```
