...
Fits to age compositions for each gear, and log standardized residuals are shown in Figures \@ref(fig:fig-base-age-fits-ft)--\@ref(fig:fig-base-age-resids-wcvis). Fits were reasonable and there were no strong patterns in the residuals. The log residuals were all bounded by [-2,2] except for very few outliers. Overall there was a slight tendency toward overfitting the age compositions with this model.")
```
