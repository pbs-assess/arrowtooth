...
(ref:fig-mat-en2) Same as previous, but with fish scored as resting removed. 

<!-- `r base_model$dat$start.yr` to `r base_model$dat$end.yr` for `r sp`.  -->

(ref:fig-mat-fr2) TODO

```{r fig-mat2, fig.cap = ifelse(fr(), "(ref:fig-mat-fr2)", "(ref:fig-mat-en2)"), fig.asp = 1, out.width = "6in"}
