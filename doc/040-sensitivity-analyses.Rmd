...
The absolute and relative biomass was almost identical to the base model for these models. The catchability estimates were also almost identical between models (\@ref(fig:fig-sens-q-q)).
")
```
...
The index fit is shown in Figure \@ref(fig:fig-sens-geostat-index-fits). The fit to the index is approximately equivalent to the fit to the index in the base model.
")
```
