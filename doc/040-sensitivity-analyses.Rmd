...
There was also substantial autocorrelation in the MCMC samples for this model (Figures \@ref(fig:fig-sens-qcs-autocor-tv) and \@ref(fig:fig-sens-qcs-sel)) and the trace plots are not adequate for valid inference (Figures \@ref(fig:fig-sens-qcs-trace-tv) and \@ref(fig:fig-sens-qcs-trace-sel-tv)).
")
```
