...
This sensitivity came about in the `r la` cycle, where it was found that the estimated selectivity curves were all to the right of the maturity ogive (Figure 17, @grandin2017). This caused the value of $F_\mathrm{MSY}$ to be very large and essentially give the advice that an unlimited amount of catch could be taken without affecting the stock. We repeat it here, as the same situation has arisen and to compare this model with the single sex one from the `r la`.
