...
In an attempt to improve the fit of the `r qcs` index (Figure @\ref(fig:fig-base-index-fits)), we implemented time-varying selectivity in `r iscam` and ran the model with the `r qcs` having three blocks of selectivity, 2003--2010, 2011--2016, and 2017--2021. The absolute and relative biomasss trajectories were not affected much, except that the sensitivity model's biomass in the final year is a little lower than the base model's (Figures \@ref(fig:fig-sens-selex) and \@ref(fig:fig-sens-selex-rel)). The index fit did improve in the latter part of the series (Figure \@ref(fig:fig-sens-selex-index-fits)). This came at the expense of a very poor estimate of selectivity. The selectivity estimates for ...
...
TODO: complete this once model is done Sept 23 11AM
