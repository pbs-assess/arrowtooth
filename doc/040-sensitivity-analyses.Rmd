...
There was also substantial autocorrelation in the MCMC samples for this model (Figures \@ref(fig:fig-sens-qcs-autocor-tv) and \@ref(fig:fig-sens-qcs-autocor-sel)) and the trace plots are not adequate for valid inference (Figures \@ref(fig:fig-sens-qcs-trace-tv) and \@ref(fig:fig-sens-qcs-trace-sel-tv)).
")
```
...
The index fit is shown in Figure \@ref(fig:fig-sens-geostat-index-fits). The fit to the index is about equivalent to the fit to the index in the base model.
")
```
