...
(ref:fig-bridge10-pairs-fr) Graphiques de paires pour les paramètres estimés par MCMC dans le modèle de transition pour lequel l'indice COHG a été supprimé. Voir la figure \@ref(fig:fig-base-priors-posts) pour les descriptions des indices $q$.
