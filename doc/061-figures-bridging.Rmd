...
(ref:fig-bridge3-pairs-en-alt) This figure shows that there are some correlations between natural mortality R bar and catchability of the `r hcs`

(ref:fig-bridge3-pairs-fr-alt) Ce graphique montre qu'il existe certaines corrélations entre la mortalité naturelle R bar et la capturabilité du `r hcs`
...
(ref:fig-bridge-fishing-year-autocor-en-alt) Ce graphique montre qu'il y a peu d'autocorrélation pour les paramètres principaux bien qu'elle soit plus importante que pour la base
