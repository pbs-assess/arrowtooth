...
All catch levels had a probability of greater than 0.5 of the `r proj_yr` biomass being under the $0.4B_0$ reference point. 

<!--The lowest catch level having a probability of greater than 0.5 of the `r proj_yr` biomass being under the $0.2B_0$ limit reference point was `r row_greater_50_50_02bo$tac`,000 t, with a probability of `r prob_greater_50_50_02bo`.-->
