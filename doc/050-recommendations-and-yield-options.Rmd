...
cat("The relationdhip between DNA and spatial area is unknown for `r sp`. In future it is recommended that a genetic study take place to determine differences between `r sp` found in the Strait of Georgia, Queen Charlotte Sound, Hecate Strait, and WCVI.")
```
...
cat("Ageing error was not used for this assessment. It is recommended that an ageing error matrix be included in the assessment model, to determine model sensitivty to ageing error.")
```
